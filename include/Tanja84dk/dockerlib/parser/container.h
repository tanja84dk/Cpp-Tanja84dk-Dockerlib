...
namespace Tanja84dk::DockerLib::Parser
{
  ...
  private:
    ...
    inline void set_port_bindings_(const std::string &port_bindings) noexcept { this->container_port_bindings_string_ = port_bindings; };
    inline void set_image_name_(const std::string &image_name) noexcept { this->container_image_string_ = image_name; };
    inline void set_working_directory_(const std::string &working_directory) noexcept { this->container_working_directory_string_ = working_directory; };
    inline void set_entry_point_(const std::string &entry_point) noexcept { this->container_entry_point_string_ = entry_point; };
  };
  ...
  struct Inspect : ContainersInterface
  {
    ...
    /// @param ordered_json_object json object as a reference
  ...
  private:
    inline std::string get_name_string_from_json_array(const nlohmann::ordered_json &jsonArrayObj, const std::string &searchString) noexcept
    {
